...
-- ÁO SPRING
INSERT IGNORE INTO SanPham (MaSP, MaDM, TenSP, MoTa, Gia, MauSac, Size, ChatLieu, SoLuongCon, HinhAnh, AnhPhu1, AnhPhu2, AnhPhu3, AnhPhu4, Season) VALUES
(1012, 101, 'Áo Thun Oversize', 'Áo thun form rộng, chất liệu mềm, thoáng khí, màu sắc trẻ trung.', 250000, 'Trắng, Đen, Hồng', 'S, M, L, XL', 'Cotton 100%', 280, 'anh_quan_ao/ao/ao_thun_oversize.jpg', 'anh_phu_ao/ao_thun_oversize_1.jpg', 'anh_phu_ao/ao_thun_oversize_2.jpg', 'anh_phu_ao/ao_thun_oversize_3.jpg', 'anh_phu_ao/ao_thun_oversize_4.jpg', 'Spring'),
(1015, 102, 'Sơ Mi Linen Tay Lửng', 'Sơ mi tay lửng, chất liệu linen thoáng mát, phù hợp mùa xuân hè.', 420000, 'Be, Xanh Nhạt', 'S, M, L', 'Linen', 130, 'anh_quan_ao/ao/so_mi_linen_tay_lung.jpg', 'anh_phu_ao/so_mi_linen_tay_lung_1.jpg', 'anh_phu_ao/so_mi_linen_tay_lung_2.jpg', 'anh_phu_ao/so_mi_linen_tay_lung_3.jpg', 'anh_phu_ao/so_mi_linen_tay_lung_4.jpg', 'Spring'),
(1007, 104, 'Áo Len Cổ Tim', 'Áo len cổ tim, mỏng nhẹ, ấm áp khi mùa thu se lạnh.', 360000, 'Hồng, Be, Xám', 'S, M, L', 'Len Acrylic', 210, 'anh_quan_ao/ao/ao_len_co_tim.jpg', 'anh_phu_ao/ao_len_co_tim_1.jpg', 'anh_phu_ao/ao_len_co_tim_2.jpg', 'anh_phu_ao/ao_len_co_tim_3.jpg', 'anh_phu_ao/ao_len_co_tim_4.jpg', 'Spring');

-- ÁO SUMMER
INSERT IGNORE INTO SanPham
(MaSP, MaDM, TenSP, MoTa, Gia, MauSac, Size, ChatLieu, SoLuongCon, HinhAnh, AnhPhu1, AnhPhu2, AnhPhu3, AnhPhu4, Season)
VALUES
(1001, 101, 'Áo Thun Cotton Basic', 'Áo thun cổ tròn, form vừa, chất liệu thoáng mát, 100% Cotton.', 199000, 'Trắng, Đen, Xám', 'S, M, L, XL', 'Cotton 100%', 350, 'anh_quan_ao/ao/ao_thun_basic.png', 'anh_phu_ao/ao_thun_basic_1.jpg', 'anh_phu_ao/ao_thun_basic_2.jpg', 'anh_phu_ao/ao_thun_basic_3.jpg', 'anh_phu_ao/ao_thun_basic_4.jpg', 'Summer'),
(1002, 102, 'Sơ Mi Linen Cổ Điển', 'Sơ mi dài tay, chất liệu linen mát, phù hợp cho mùa hè.', 450000, 'Be, Xanh Navy', 'S, M, L', 'Linen Tự Nhiên', 120, 'anh_quan_ao/ao/so_mi_len_co_dien.jpg', 'anh_phu_ao/so_mi_len_co_dien_1.jpg', 'anh_phu_ao/so_mi_len_co_dien_2.jpg', 'anh_phu_ao/so_mi_len_co_dien_3.jpg', 'anh_phu_ao/so_mi_len_co_dien_4.jpg', 'Summer'),
(1003, 101, 'Áo Polo Cotton Pique', 'Áo polo phom cơ bản, cổ dệt kim, chất liệu Pique thoáng khí.', 290000, 'Đen, Trắng, Xanh rêu', 'S, M, L, XL', 'Cotton Pique', 250, 'anh_quan_ao/ao/ao_polo_cotton_pique.jpg', 'anh_phu_ao/ao_polo_cotton_pique_1.jpg', 'anh_phu_ao/ao_polo_cotton_pique_2.jpg', 'anh_phu_ao/ao_polo_cotton_pique_3.jpg', 'anh_phu_ao/ao_polo_cotton_pique_4.jpg', 'Summer'),
...
(1011, 102, 'Sơ Mi Cộc Tay Kẻ Sọc', 'Sơ mi ngắn tay, kẻ sọc thời trang, vải cotton thoáng mát.', 330000, 'Trắng, Xanh', 'S, M, L, XL', 'Cotton', 180, 'anh_quan_ao/ao/so_mi_coc_tay_ke_soc.jpeg', 'anh_phu_ao/so_mi_coc_tay_ke_soc_1.jpeg', 'anh_phu_ao/so_mi_coc_tay_ke_soc_2.jpeg', 'anh_phu_ao/so_mi_coc_tay_ke_soc_3.jpeg', 'anh_phu_ao/so_mi_coc_tay_ke_soc_4.jpeg', 'Summer');

-- ÁO AUTUMN
INSERT IGNORE INTO SanPham
(MaSP, MaDM, TenSP, MoTa, Gia, MauSac, Size, ChatLieu, SoLuongCon, HinhAnh, AnhPhu1, AnhPhu2, AnhPhu3, AnhPhu4, Season)
VALUES
(1006, 103, 'Áo Len Mỏng Cổ Tròn', 'Áo len mỏng, form vừa, mềm mại, thoáng khí, phù hợp mùa thu.', 320000, 'Be, Nâu, Xám', 'S, M, L', 'Acrylic và Len', 200, 'anh_quan_ao/ao/ao_len_co_tron.jpg', 'anh_phu_ao/ao_len_co_tron_1.jpg', 'anh_phu_ao/ao_len_co_tron_2.jpg', 'anh_phu_ao/ao_len_co_tron_3.jpg', 'anh_phu_ao/ao_len_co_tron_4.jpg', 'Autumn'),
(1009, 103, 'Áo Khoác Cardigan Dài', 'Áo cardigan dệt kim dài, nhẹ nhàng, ấm áp, phong cách Hàn Quốc.', 490000, 'Xám, Đen, Be', 'S, M, L', 'Len tổng hợp', 300, 'anh_quan_ao/ao/ao_len_cardigan.jpg', 'anh_phu_ao/ao_len_cardigan_1.jpg', 'anh_phu_ao/ao_len_cardigan_2.jpg', 'anh_phu_ao/ao_len_cardigan_3.jpg', 'anh_phu_ao/ao_len_cardigan_4.jpg', 'Autumn'),
(1013, 104, 'Áo Len Cổ Tim', 'Áo len cổ tim, mỏng nhẹ, ấm áp khi mùa thu se lạnh.', 360000, 'Hồng, Be, Xám', 'S, M, L', 'Len Acrylic', 210, 'anh_quan_ao/ao/ao_len_co_tim.jpg', 'anh_phu_ao/ao_len_co_tim_1.jpg', 'anh_phu_ao/ao_len_co_tim_2.jpg', 'anh_phu_ao/ao_len_co_tim_3.jpg', 'anh_phu_ao/ao_len_co_tim_4.jpg', 'Autumn'),
(1017, 103, 'Áo Hoodie Mỏng', 'Áo hoodie mỏng, form rộng, phù hợp mùa thu se lạnh.', 500000, 'Xám, Đen, Be', 'S, M, L, XL', 'Nỉ mỏng', 170, 'anh_quan_ao/ao/ao_hoodie_mong.jpg', 'anh_phu_ao/ao_hoodie_mong_1.jpg', 'anh_phu_ao/ao_hoodie_mong_2.jpg', 'anh_phu_ao/ao_hoodie_mong_3.jpg', 'anh_phu_ao/ao_hoodie_mong_4.jpg', 'Autumn');

-- ÁO WINTER
INSERT IGNORE INTO SanPham
(MaSP, MaDM, TenSP, MoTa, Gia, MauSac, Size, ChatLieu, SoLuongCon, HinhAnh, AnhPhu1, AnhPhu2, AnhPhu3, AnhPhu4, Season)
VALUES
(1004, 103, 'Áo Hoodie Nỉ Phom Rộng', 'Áo hoodie có mũ, phom rộng thoải mái, nỉ bông dày dặn.', 550000, 'Xám tro, Kem, Đen', 'M, L, XL', 'Nỉ Bông (Fleece)', 180, 'anh_quan_ao/ao/ao_hoodie_ni_phom_rong.jpg', 'anh_phu_ao/ao_hoodie_ni_phom_rong_1.jpg', 'anh_phu_ao/ao_hoodie_ni_phom_rong_2.jpg', 'anh_phu_ao/ao_hoodie_ni_phom_rong_3.jpg', 'anh_phu_ao/ao_hoodie_ni_phom_rong_4.jpg', 'Winter'),
(1005, 103, 'Áo Khoác Gió Hai Lớp', 'Áo khoác ngoài nhẹ, chống nước nhẹ, có khóa kéo và mũ.', 690000, 'Xanh Navy, Be, Xám', 'S, M, L, XL', 'Polyester', 100, 'anh_quan_ao/ao/ao_khoac_gio_hai_lop.jpg', 'anh_phu_ao/ao_khoac_gio_hai_lop_1.jpg', 'anh_phu_ao/ao_khoac_gio_hai_lop_2.jpg', 'anh_phu_ao/ao_khoac_gio_hai_lop_3.jpg', 'anh_phu_ao/ao_khoac_gio_hai_lop_4.jpg', 'Winter'),
(1010, 105, 'Áo Khoác Phao Lông Vũ', 'Áo khoác phao dày, giữ nhiệt tốt, chống gió cho mùa đông.', 850000, 'Đen, Xanh Navy', 'M, L, XL', 'Lông Vũ + Polyester', 600, 'anh_quan_ao/ao/ao_khoac_phao_long_vu.jpg', 'anh_phu_ao/ao_khoac_phao_long_vu_1.jpg', 'anh_phu_ao/ao_khoac_phao_long_vu_2.jpg', 'anh_phu_ao/ao_khoac_phao_long_vu_3.jpg', 'anh_phu_ao/ao_khoac_phao_long_vu_4.jpg', 'Winter'),
(1014, 105, 'Áo Khoác Dạ Ngắn', 'Áo khoác dạ ngắn, giữ nhiệt tốt, kiểu dáng trẻ trung.', 780000, 'Đen, Xanh Navy', 'M, L, XL', 'Len + Polyester', 550, 'anh_quan_ao/ao/ao_khoac_da_ngan.jpg', 'anh_phu_ao/ao_khoac_da_ngan_1.jpg', 'anh_phu_ao/ao_khoac_da_ngan_2.jpg', 'anh_phu_ao/ao_khoac_da_ngan_3.jpg', 'anh_phu_ao/ao_khoac_da_ngan_4.jpg', 'Winter'),
(1018, 104, 'Áo Len Cổ Lọ', 'Áo len cổ lọ, giữ ấm nhẹ, phong cách thanh lịch cho mùa đông.', 400000, 'Đen, Xám, Nâu', 'S, M, L', 'Len Acrylic', 320, 'anh_quan_ao/ao/ao_len_co_lo.jpg', 'anh_phu_ao/ao_len_co_lo_1.jpg', 'anh_phu_ao/ao_len_co_lo_2.jpg', 'anh_phu_ao/ao_len_co_lo_3.jpg', 'anh_phu_ao/ao_len_co_lo_4.jpg', 'Winter');

-- QUẦN & VÁY - SPRING
INSERT IGNORE INTO SanPham (MaSP, MaDM, TenSP, MoTa, Gia, MauSac, Size, ChatLieu, SoLuongCon, HinhAnh, AnhPhu1, AnhPhu2, AnhPhu3, AnhPhu4, Season) VALUES
(2001, 201, 'Quần Jeans Slim-fit', 'Quần jeans dáng đứng, tối giản, không rách.', 650000, 'Xanh Đậm, Đen', '29, 30, 31, 32', 'Denim Co Giãn', 200, 'anh_quan_ao/quan/quan_jean_slim_fit.jpg', 'anh_phu_quan/quan_jean_slim_fit_1.jpg', 'anh_phu_quan/quan_jean_slim_fit_2.jpg', 'anh_phu_quan/quan_jean_slim_fit_3.jpg', 'anh_phu_quan/quan_jean_slim_fit_4.jpg', 'Spring'),
...
(2004, 202, 'Quần Short Kaki Phẳng', 'Quần short đứng dáng, độ dài trên gối, cạp phẳng.', 280000, 'Trắng ngà, Xanh mint', '29, 30, 31, 32', 'Kaki', 140, 'anh_quan_ao/quan/quan_short_kaki.jpg', 'anh_phu_quan/quan_short_kaki_1.jpg', 'anh_phu_quan/quan_short_kaki_2.jpg', 'anh_phu_quan/quan_short_kaki_3.jpg', 'anh_phu_quan/quan_short_kaki_4.jpg', 'Spring'),
(2007, 202, 'Quần Short Thun Năng Động', 'Quần short thun, co giãn, form thoải mái, mùa hạ.', 250000, 'Xám, Đen, Xanh', 'S, M, L, XL', 'Cotton/Spandex', 130, 'anh_quan_ao/quan/quan_short_thun_nang_dong.jpg', 'anh_phu_quan/quan_short_thun_nang_dong_1.jpg', 'anh_phu_quan/quan_short_thun_nang_dong_2.jpg', 'anh_phu_quan/quan_short_thun_nang_dong_3.jpg', 'anh_phu_quan/quan_short_thun_nang_dong_4.jpg', 'Spring'),
(2008, 203, 'Chân Váy Suông Dài', 'Chân váy suông dài, thoáng mát, dễ phối đồ.', 320000, 'Xanh, Be, Nâu', 'S, M, L', 'Voan', 150, 'anh_quan_ao/quan/chan_vay_suong_dai.jpg', 'anh_phu_quan/chan_vay_suong_dai_1.jpg', 'anh_phu_quan/chan_vay_suong_dai_2.jpg', 'anh_phu_quan/chan_vay_suong_dai_3.jpg', 'anh_phu_quan/chan_vay_suong_dai_4.jpg', 'Spring'),
(2002, 203, 'Chân Váy Chữ A cơ bản', 'Chan vay chu A, tre trung, de phoi do.', 300000, 'Den, Be, Xanh', 'S, M, L', 'Cotton/Polyester', 150, 'anh_quan_ao/quan/chan_vay_chu_a.jpg', 'anh_phu_quan/chan_vay_chu_a_1.jpg', 'anh_phu_quan/chan_vay_chu_a_2.jpg', 'anh_phu_quan/chan_vay_chu_a_3.jpg', 'anh_phu_quan/chan_vay_chu_a_4.jpg', 'Spring');

-- QUẦN & VÁY - AUTUMN
INSERT IGNORE INTO SanPham (MaSP, MaDM, TenSP, MoTa, Gia, MauSac, Size, ChatLieu, SoLuongCon, HinhAnh, AnhPhu1, AnhPhu2, AnhPhu3, AnhPhu4, Season) VALUES
(2005, 201, 'Quần Jeans Ống Suông', 'Quần jeans ống suông, co giãn nhẹ, dáng rộng thoải mái.', 380000, 'Xanh Denim, Đen', '29, 30, 31, 32', 'Denim Cotton', 200, 'anh_quan_ao/quan/quan_jeans_ong_suong.jpg', 'anh_phu_quan/quan_jeans_ong_suong_1.jpg', 'anh_phu_quan/quan_jeans_ong_suong_2.jpg', 'anh_phu_quan/quan_jeans_ong_suong_3.jpg', 'anh_phu_quan/quan_jeans_ong_suong_4.jpg', 'Autumn'),
(2003, 201, 'Quần Jogger Thun Basic', 'Quần jogger bo gấu, lưng thun, có dây rút, thích hợp mặc nhà/tập luyện.', 350000, 'Đen, Xám Melange', 'S, M, L, XL', 'Cotton/Spandex', 160, 'anh_quan_ao/quan/quan_jogger_thun.jpg', 'anh_phu_quan/quan_jogger_thun_1.jpg', 'anh_phu_quan/quan_jogger_thun_2.jpg', 'anh_phu_quan/quan_jogger_thun_3.jpg', 'anh_phu_quan/quan_jogger_thun_4.jpg', 'Autumn'),
(2009, 201, 'Quần Jogger Nỉ Ấm', 'Quần jogger nỉ, giữ ấm, thích hợp mùa thu/đông.', 400000, 'Xám, Đen, Xanh Navy', 'S, M, L, XL', 'Nỉ Cotton', 200, 'anh_quan_ao/quan/quan_jogger_ni_am.jpg', 'anh_phu_quan/quan_jogger_ni_am_1.jpg', 'anh_phu_quan/quan_jogger_ni_am_2.jpg', 'anh_phu_quan/quan_jogger_ni_am_3.jpg', 'anh_phu_quan/quan_jogger_ni_am_4.jpg', 'Autumn'),
(2011, 201, 'Quần Legging Nỉ', 'Quần legging nỉ, giữ ấm, dáng ôm, thích hợp mùa đông.', 380000, 'Đen, Xám', 'S, M, L, XL', 'Nỉ Cotton', 180, 'anh_quan_ao/quan/quan_legging_ni.jpg', 'anh_phu_quan/quan_legging_ni_1.jpg', 'anh_phu_quan/quan_legging_ni_2.jpg', 'anh_phu_quan/quan_legging_ni_3.jpg', 'anh_phu_quan/quan_legging_ni_4.jpg', 'Autumn'),
(2013, 203, 'Chân Váy Dài Len', 'Chân váy len dài, giữ ấm, form suông thoải mái.', 350000, 'Be, Nâu, Xám', 'S, M, L', 'Len Acrylic', 180, 'anh_quan_ao/quan/chan_vay_dai_len.jpg', 'anh_phu_quan/chan_vay_dai_len_1.jpg', 'anh_phu_quan/chan_vay_dai_len_2.jpg', 'anh_phu_quan/chan_vay_dai_len_3.jpg', 'anh_phu_quan/chan_vay_dai_len_4.jpg', 'Autumn');

-- QUẦN & VÁY - WINTER
INSERT IGNORE INTO SanPham (MaSP, MaDM, TenSP, MoTa, Gia, MauSac, Size, ChatLieu, SoLuongCon, HinhAnh, AnhPhu1, AnhPhu2, AnhPhu3, AnhPhu4, Season) VALUES
(2010, 201, 'Quần Jeans Ống Côn', 'Quần jeans ống côn, dáng ôm vừa, tối giản.', 390000, 'Xanh Denim, Đen', '29, 30, 31, 32', 'Denim Cotton', 210, 'anh_quan_ao/quan/quan_jeans_ong_con.jpg', 'anh_phu_quan/quan_jeans_ong_con_1.jpg', 'anh_phu_quan/quan_jeans_ong_con_2.jpg', 'anh_phu_quan/quan_jeans_ong_con_3.jpg', 'anh_phu_quan/quan_jeans_ong_con_4.jpg', 'Winter'),
(2012, 201, 'Quần Dạ Ống Rộng', 'Quần dạ ống rộng, giữ ấm, phong cách thanh lịch.', 500000, 'Đen, Xám, Nâu', '29, 30, 31, 32', 'Dạ + Polyester', 250, 'anh_quan_ao/quan/quan_da_ong_rong.jpg', 'anh_phu_quan/quan_da_ong_rong_1.jpg', 'anh_phu_quan/quan_da_ong_rong_2.jpg', 'anh_phu_quan/quan_da_ong_rong_3.jpg', 'anh_phu_quan/quan_da_ong_rong_4.jpg', 'Winter');
...
(3006, 301, 'Túi Đeo Chéo Mini', 'Túi đeo chéo nhỏ gọn, phong cách casual, nhiều ngăn.', 220000, 'Đen, Xám, Nâu', 'Free Size', 'Canvas + Polyester', 250, 'anh_quan_ao/phu_kien/tui_deo_cheo_mini.jpg', 'anh_phu_phu_kien/tui_deo_cheo_mini_1.jpg', 'anh_phu_phu_kien/tui_deo_cheo_mini_2.jpg', 'anh_phu_phu_kien/tui_deo_cheo_mini_3.jpg', 'anh_phu_phu_kien/tui_deo_cheo_mini_4.jpg', 'Spring'),
...
(3003, 301, 'Túi Tote Vải Canvas Lớn', 'Túi vải canvas khổ lớn, quai đeo vai, in chữ tối giản.', 150000, 'Trắng, Đen', 'Free Size', 'Canvas dày', 300, 'anh_quan_ao/phu_kien/tui_tote_vai_canvas.jpg', 'anh_phu_phu_kien/tui_tote_vai_canvas_1.jpg', 'anh_phu_phu_kien/tui_tote_vai_canvas_2.jpg', 'anh_phu_phu_kien/tui_tote_vai_canvas_3.jpg', 'anh_phu_phu_kien/tui_tote_vai_canvas_4.jpg', 'Summer'),
...
(3008, 302, 'Mũ Beanie Len', 'Mũ beanie chất liệu len acrylic, giữ ấm mùa đông.', 180000, 'Đen, Xám, Nâu', 'Free Size', 'Len Acrylic', 120, 'anh_quan_ao/phu_kien/mu_beanie_len.jpg', 'anh_phu_phu_kien/mu_beanie_len_1.jpg', 'anh_phu_phu_kien/mu_beanie_len_2.jpg', 'anh_phu_phu_kien/mu_beanie_len_3.jpg', 'anh_phu_phu_kien/mu_beanie_len_4.jpg', 'Autumn'),
