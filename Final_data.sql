...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'e90674b2-b037-11f0-98bc-1579213bc118:1-409';
...
INSERT INTO `DonHang` VALUES (1,1012,6,1,NULL,NULL,'Đang Xử Lý',250000,'',NULL,NULL,0),(2,1011,6,1,NULL,NULL,'Đang Xử Lý',330000,'',NULL,NULL,0),(3,1003,6,1,NULL,NULL,'Đang Xử Lý',290000,'',NULL,NULL,0),(4,1004,6,1,NULL,NULL,'Đang Xử Lý',550000,'',NULL,NULL,0),(5,1004,6,1,NULL,NULL,'Đang Xử Lý',550000,'Kem',NULL,NULL,0),(6,1004,18,1,NULL,NULL,'Đã hủy',550000,'Xám tro',NULL,NULL,0),(7,1003,18,1,290000,290000,'Đã giao thành công',NULL,'',NULL,NULL,0),(8,1003,18,1,290000,290000,'Đã giao thành công',NULL,'Trắng',NULL,NULL,0),(9,1004,18,1,550000,550000,'Chờ bạn xác nhận',NULL,'',NULL,'2025-11-08 13:01:15',0),(10,1001,18,1,199000,199000,'Chờ bạn xác nhận',NULL,'Xám',NULL,'2025-11-08 13:01:22',0),(11,1012,18,1,250000,250000,'Chờ bạn xác nhận',NULL,'Đen',NULL,'2025-11-08 13:01:30',0),(12,1003,18,1,290000,290000,'Chờ bạn xác nhận',NULL,'Trắng','','2025-11-10 15:56:46',0),(13,1003,18,1,290000,290000,'Chờ xác nhận đơn',NULL,'Xanh rêu','L','2025-11-12 16:26:42',0),(14,1004,18,1,550000,550000,'Chờ xác nhận đơn',NULL,'Trắng','L','2025-11-12 16:26:42',0),(15,1004,18,2,550000,1100000,'Chờ xác nhận đơn',NULL,'Xám tro','M','2025-11-12 16:27:15',0),(16,2009,18,1,400000,400000,'Chờ xác nhận đơn',NULL,'Đen','XL','2025-11-13 14:28:43',0),(17,3011,18,2,200000,400000,'Chờ xác nhận đơn',NULL,'Xanh Olive','Free Size','2025-11-13 16:55:08',0);
...
CREATE TABLE `Mau` (
  ...
  `ten_mau` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Tên màu chuẩn hóa',
  `ma_hex` varchar(7) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Mã màu hex (tùy chọn)',
  PRIMARY KEY (`id`),
...
/*!50001 VIEW `revenue` AS select 1 AS `GiaNgayHomNay` */;
...
-- Dump completed on 2025-11-13 19:02:18
