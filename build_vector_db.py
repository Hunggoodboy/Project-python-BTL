...
# --- 1. KẾT NỐI DATABASE ---
# (Đảm bảo file connect.py nằm đúng vị trí)
...
# # Dùng create_collection để đảm bảo nó luôn MỚI
...
def get_all_products_as_text():
    ...
    try:
        ...
        # Câu lệnh này đảm bảo MỖI SẢN PHẨM CHỈ CÓ 1 HÀNG DUY NHẤT
        sql = """
        ...
        print(f"Đã tìm thấy {len(products)} sản phẩm (đã gom size).")
        ...
        for idx, product in enumerate(products):
            ...
            metadata = {
                ...
                "Season": str(season_val or ""),  # Chuyển "None" thành ""
            ...
            product_ids.append(str(product.get('MaSP')))
